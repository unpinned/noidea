...
static PART3: &str = r#" UTC</mark></td>
  ...
  <tr>
    <th scope="row">Testing Silverblue 39</th>
    <td><mark>"#;
static PART4: &str = r#" UTC</mark></td>
</tr>
<tr>
  <th scope="row">Testing Kinoite 39</th>
  <td><mark>"#;
...
async fn testing_fetch_website() -> String {
    let website = reqwest::get(
        "https://kojipkgs.fedoraproject.org/ostree/repo/refs/heads/fedora/39/x86_64/testing//",
    )
    .await
    .unwrap()
    .text()
